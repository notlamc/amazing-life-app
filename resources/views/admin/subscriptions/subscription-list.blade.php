...
$(document).ready(function(){
    ...
    let table = $('#subscriptionTable').DataTable({
        ajax: "{{ route('superadmin.subscriptions.list') }}",
        columns: [
            ...
            },
            {
                ...
                render: function(id){
                    return `
                        <a href="{{ url('superadmin/subscriptions') }}/${id}/edit" class="text-primary viewUser me-2" title="View">
                            
                                <i class="fa-solid fa-pen fs-5"></i>                       
                            </a>
                        <a href="{{ url('superadmin/subscriptions') }}/${id}/view" class="text-info me-2" title="View">
    ...
    //  Status toggle
		$(document).on('change', '.toggle-status', function(){
			...
			$.ajax({ 
				url: "{{ route('superadmin.subscriptions.toggleStatus') }}",
				type: "POST",
