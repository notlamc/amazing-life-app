        ...
        <div class="content container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="siteSettingForm" action="{{ route('superadmin.site.setting.update') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
								...
								<input type="text" name="referral_commission"
									...
									value="{{ (isset($setting->referral_commission) && (int)$setting->referral_commission !== 0) ? $setting->referral_commission : '' }}">
							</div>
							...
							<div class="col-md-6">
								...
								<input type="text" name="extend_duration_days"
									class="form-control only-number"
									placeholder="e.g. 30"
									value="{{ (isset($setting->extend_duration_days) && (int)$setting->extend_duration_days !== 0) ? $setting->extend_duration_days : '' }}">
							</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mt-2">
                                    <img id="logoPreview"
										src="{{ $setting->logo ? asset($setting->logo) : asset('assets/img/placeholder.png') }}"
							...
							<div class="col-md-6">
                                ...
                                <div class="mt-2">
                                    <img id="small_logoPreview"
										src="{{ $setting->small_logo ? asset($setting->small_logo) : asset('assets/img/placeholder.png') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mt-2">
                                    <img id="faviconPreview"
										src="{{ $setting->favicon ? asset($setting->favicon) : asset('assets/img/placeholder.png') }}"
										width="40" class="rounded">
                                </div>
                            </div>
...
<script>
	$(document).ready(function(){
		...
		const logoRequired = @json(!$setting->logo); 
		const faviconRequired = @json(!$setting->favicon); 
