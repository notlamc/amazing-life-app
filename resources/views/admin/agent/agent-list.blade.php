		...
		<div class="content container-fluid">
			<div class="page-header">
				<div class="row align-items-center">
					<div class="col-sm-6">
						<h3 class="page-title mb-0">List of Agents</h3>
					</div>
...
<script>
	$(document).ready(function(){
		...
		let table = $('#userTable').DataTable({
			...
			columns: [
				...
				{ 
					...
					render: function(id){
						return `
							<a href="javascript:void(0)" class="text-info editAgent me-2" data-id="${id}" title="Edit">
								<i class="fa-solid fa-pen fs-5"></i>
							</a>
							<a href="/admin/agent/view/${id}" class="text-primary viewUser me-2" title="View">
								<i class="fa-solid fa-eye fs-5"></i>
							</a>
							<a href="javascript:void(0)" class="text-danger deleteAgent" data-id="${id}" title="Delete">
		...
		$(document).on('click', '.editAgent', function() {
			...
			let url = "{{ route('admin.agent.edit', ':id') }}";
