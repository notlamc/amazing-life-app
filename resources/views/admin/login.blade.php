...
<body>
			...
			<div class="loginbox bg-white p-4 rounded-4 shadow-lg border-0">
				<div class="login-right">
					<div class="login-right-wrap">
						<!-- <img src="{{ asset('assets/img/logo.png')}}" alt="Amazing Life App"  width="250" height="80"> -->
						...
						<div class="text-center forgotpass mt-3">
							<a href="{{route('admin.forgot-password')}}" class="text-decoration-none text-primary small">Forgot Password?</a>
						</div>
	...
	<!-- /Main Wrapper -->
	<!-- jQuery -->
	<script src="{{ asset('assets/js/jquery-3.7.1.min.js') }}" type="ff9f2b1bfd9653bfa488e43b-text/javascript"></script>		
	<!-- Bootstrap Core JS -->
	<script src="{{ asset('assets/js/bootstrap.bundle.min.js') }}" type="ff9f2b1bfd9653bfa488e43b-text/javascript"></script>
	<!-- Custom JS -->
	<script src="{{ asset('assets/js/script.js') }}" type="ff9f2b1bfd9653bfa488e43b-text/javascript"></script>
	<script src="{{ asset('assets/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}" data-cf-settings="ff9f2b1bfd9653bfa488e43b-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"943bce2eafe08575","version":"2025.4.0-1-g37f21b1","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>
</html>
