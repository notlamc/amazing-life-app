...
class SubscriptionController extends Controller
{
    ...
    {
        return view('admin.subscriptions.subscription-list');
    }
    ...
    {
        $subscription = Subscription::findOrFail($request->id);
        $subscription->status = ($subscription->status === 'active') ? 'deactive' : 'active';
        $subscription->save();
    ...
    {
        $subscription = Subscription::findOrFail($id);
        return view('admin.subscriptions.subscription-view', compact('subscription'));
    }
