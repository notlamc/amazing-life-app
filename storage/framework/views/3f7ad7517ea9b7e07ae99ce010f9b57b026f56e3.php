...
<!-- <script>
	$(document).ready(function(){
		...
		// 		let reader = new FileReader();
		// 		reader.onload = function(e){
		// 			$('#videoPreview').attr('src', "<?php echo e(asset('assets/img/icons/video-file.png')); ?>"); // placeholder icon
		// 		}
		// 		reader.readAsDataURL(file);
		// 	}
		// });
			...
			submitHandler: function(form){
				Swal.fire({
					...
					if (result.isConfirmed) {
						...
						$.ajax({
							url: "<?php echo e(route('superadmin.video.store')); ?>",
							type: "POST",
							data: formData,
							processData: false,
							contentType: false,
...
<?php /**PATH F:\xampp\htdocs\amazinglifeapp\resources\views/admin/video/video-add.blade.php ENDPATH**/ ?>