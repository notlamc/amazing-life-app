			...
			<div class="page-header">
				<div class="row align-items-center">
					...
					<div class="col-sm-6 text-end">
						<a href="<?php echo e(route('superadmin.videos.create')); ?>" class="btn btn-primary">
...
<script>
	$(document).ready(function(){
		 ...
		 let table = $('#userTable').DataTable({
			ajax: "<?php echo e(route('superadmin.video.list')); ?>",
			columns: [
		...
		$(document).on('change', '.toggle-status', function(){
			let id = $(this).data('id');
			$.ajax({ 
				url: "<?php echo e(route('superadmin.video.status')); ?>",
				type: "POST",
		...
		$(document).on('click', '.deleteVideo', function(){
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					$.ajax({
						url: "<?php echo e(route('superadmin.video.delete')); ?>",
						type: "POST",
						data: { id: id, _token: "<?php echo e(csrf_token()); ?>" },
						success: function(res){
		...
		$(document).on('click', '.editVideo', function() {
			...
			let url = "<?php echo e(route('superadmin.video.edit', ':id')); ?>";
...
<?php /**PATH F:\xampp\htdocs\amazinglifeapp\resources\views/admin/video/video-list.blade.php ENDPATH**/ ?>