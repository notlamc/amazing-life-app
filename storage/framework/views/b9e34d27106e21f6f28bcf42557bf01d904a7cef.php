									...
									<form id="videoForm" enctype="multipart/form-data">
										...
										<div class="row g-3">
														...
														<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<div class="multiselect-row">
																<input class="form-check-input custom-check category-checkbox"
																	...
																	<?php if(in_array((string)$cat->id, $savedCategories)): ?> checked <?php endif; ?>>
																<label for="cat<?php echo e($cat->id); ?>" style="margin:0;cursor:pointer;"><?php echo e($cat->name); ?></label>
															</div>
											...
											<div class="col-md-12">
												...
												<input type="text" name="title" class="form-control" placeholder="Enter title" value="<?php echo e(old('name', $video->title ?? '')); ?>" required>
											</div>
											...
											<div class="col-md-6">
												...
												<div class="mt-2">
													<img id="photoPreview"
														src="<?php echo e(isset($video->thumbnail_path) && $video->thumbnail_path ? asset($video->thumbnail_path) : asset('assets/img/profiles/default-avatar.png')); ?>"
														width="100"
											...
											<div class="col-md-6">
												...
												<div class="mt-2">
													...
													<img id="videoPreview" src="<?php echo e(asset('assets/img/profiles/default-avatar.png')); ?>" 
											...
											<div class="col-md-12">
												...
												<textarea type="description" name="description" class="form-control" placeholder="Enter Description" required><?php echo e(old('email', $video->description ?? '')); ?></textarea>
											</div>

											<div class="col-md-6">
												<label class="form-label">Tags <span class="text-danger">*</span></label>
												<textarea type="tags" name="tags" class="form-control" placeholder="Enter tags"><?php echo e(old('email', $video->tags ?? '')); ?></textarea>
											</div>

											<div class="col-md-6">
												<label class="form-label">Mata Tags <span class="text-danger">*</span></label>
												<textarea type="metatags" name="metatags" class="form-control" placeholder="Enter metatags"><?php echo e(old('email', $video->metatags ?? '')); ?></textarea>
											</div>
			...
			$(document).ready(function(){
				...
				$("#videoForm").validate({
					...
					submitHandler: function(form){
						...
						$.ajax({
							url: "<?php echo e(route('superadmin.video.update', $video->id)); ?>",
							type: "POST",
							data: formData,
							processData: false,
							contentType: false,
...
</style><?php /**PATH F:\xampp\htdocs\amazinglifeapp\resources\views/admin/video/video-edit.blade.php ENDPATH**/ ?>